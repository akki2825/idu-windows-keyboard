...
// app discards it instead of inserting text. Ctrl taps around the Alt
// release/re-press keep the target from reading either transition as a bare
// Alt tap, which would move focus to its menu bar.
